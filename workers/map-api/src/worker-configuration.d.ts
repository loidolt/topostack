/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example src/worker-configuration.d.ts` (hash: 67875030a283e03b7ff85a00c2888c1c)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "http://localhost:5173,http://127.0.0.1:5173,https://topostack.loidolt.space,https://www.atomm.com" | "https://topostack.loidolt.space,https://www.atomm.com";
	TERRAIN_ORIGIN: "https://s3.amazonaws.com/elevation-tiles-prod/terrarium";
	GEOCODER_ORIGIN: "https://api.geoapify.com";
	DATASET_VERSION: "mapzen-terrarium+osm-pmtiles-v1";
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ALLOWED_ORIGINS: "https://topostack.loidolt.space,https://www.atomm.com";
		TERRAIN_ORIGIN: "https://s3.amazonaws.com/elevation-tiles-prod/terrarium";
		GEOCODER_ORIGIN: "https://api.geoapify.com";
		DATASET_VERSION: "mapzen-terrarium+osm-pmtiles-v1";
		GEOCODER_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "TERRAIN_ORIGIN" | "GEOCODER_ORIGIN" | "DATASET_VERSION" | "GEOCODER_API_KEY">> {}
}
