...
export function exportBlockReason(geometry: GeometryIRV1, project: ProjectConfigV1): string | undefined {
  ...
  if (geometry.vectorStatus === "unavailable" && (project.showRoads || project.showTrails || project.showWater)) return "Transportation and water data is unavailable. Disable those map details or regenerate after the service is restored.";
