...
2. Add editable label placement with font outlining and collision repair.
3. Add custom SVG crop boundaries, DXF export, sheet nesting, and multi-panel tabletop splitting.
4. Add frames, alignment/joinery templates, bills of material, machine presets, and explicit kerf calibration projects.
5. Add optional cloud project synchronization behind a portable identity adapter.
